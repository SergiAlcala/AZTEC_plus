...
if synthetic_dataset == 1:
    ...
    folder_results = f'{today_date}_{T_mno}min_2daysHist_Real_Data_0.8_'
...
topo_file             = os.path.join('/home/jupyter-sergi/2023_02_03 - CoNEXT benchmark - shared', 'structures', 'oneLink_topo_ctot_0.8.json')
