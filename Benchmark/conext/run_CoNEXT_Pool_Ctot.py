...
def myMultiOpt(idx):
    ...
    if synthetic_dataset == 1:
        ...
        folder_results = f'CTOT/{today_date}_{T_mno}min_2daysHist_Synthetic_Data_CTOT_{Ctot}_'
        ...
        folder_results = f'CTOT/{today_date}_{T_mno}min_2daysHist_Real_Data_CTOT_{Ctot}_'
    ...
    topo_file             = os.path.join('/home/jupyter-sergi/2023_02_03 - CoNEXT benchmark - shared', 'structures', f'oneLink_topo_ctot_{Ctot}.json')
    if doTopology:
